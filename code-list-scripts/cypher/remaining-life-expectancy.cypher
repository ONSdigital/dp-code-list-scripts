...
MATCH (parent:`_code_list`:`_code_list_remaining-life-expectancy`),(node:`_code`:`_code_remaining-life-expectancy` { value:"15-years-remaining-life-expectancy" }) MERGE (node)-[:usedBy { label:"% with 15 years remaining life expectancy"}]->(parent);
MERGE (node:`_code`:`_code_remaining-life-expectancy` { value:"5-years-remaining-life-expectancy" });
MATCH (parent:`_code_list`:`_code_list_remaining-life-expectancy`),(node:`_code`:`_code_remaining-life-expectancy` { value:"5-years-remaining-life-expectancy" }) MERGE (node)-[:usedBy { label:"% with 5 years remaining life expectancy"}]->(parent);
