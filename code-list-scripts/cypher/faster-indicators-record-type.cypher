...
MERGE (node:`_code`:`_code_faster-indicators-record-type` { value:"none" });
MATCH (parent:`_code_list`:`_code_list_faster-indicators-record-type`),                (node:`_code`:`_code_faster-indicators-record-type` { value:"none" })                 MERGE (node)-[:usedBy { label:"none"}]->(parent);
