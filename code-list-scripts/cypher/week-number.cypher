...
MERGE (node:`_code`:`_code_week-number` { value:"week-01" });
MATCH (parent:`_code_list`:`_code_list_week-number`),(node:`_code`:`_code_week-number` { value:"week-01" }) MERGE (node)-[:usedBy { label:"Week 01"}]->(parent);
MERGE (node:`_code`:`_code_week-number` { value:"week-02" });
MATCH (parent:`_code_list`:`_code_list_week-number`),(node:`_code`:`_code_week-number` { value:"week-02" }) MERGE (node)-[:usedBy { label:"Week 02"}]->(parent);
MERGE (node:`_code`:`_code_week-number` { value:"week-03" });
MATCH (parent:`_code_list`:`_code_list_week-number`),(node:`_code`:`_code_week-number` { value:"week-03" }) MERGE (node)-[:usedBy { label:"Week 03"}]->(parent);
MERGE (node:`_code`:`_code_week-number` { value:"week-04" });
MATCH (parent:`_code_list`:`_code_list_week-number`),(node:`_code`:`_code_week-number` { value:"week-04" }) MERGE (node)-[:usedBy { label:"Week 04"}]->(parent);
MERGE (node:`_code`:`_code_week-number` { value:"week-05" });
MATCH (parent:`_code_list`:`_code_list_week-number`),(node:`_code`:`_code_week-number` { value:"week-05" }) MERGE (node)-[:usedBy { label:"Week 05"}]->(parent);
MERGE (node:`_code`:`_code_week-number` { value:"week-06" });
MATCH (parent:`_code_list`:`_code_list_week-number`),(node:`_code`:`_code_week-number` { value:"week-06" }) MERGE (node)-[:usedBy { label:"Week 06"}]->(parent);
MERGE (node:`_code`:`_code_week-number` { value:"week-07" });
MATCH (parent:`_code_list`:`_code_list_week-number`),(node:`_code`:`_code_week-number` { value:"week-07" }) MERGE (node)-[:usedBy { label:"Week 07"}]->(parent);
MERGE (node:`_code`:`_code_week-number` { value:"week-08" });
MATCH (parent:`_code_list`:`_code_list_week-number`),(node:`_code`:`_code_week-number` { value:"week-08" }) MERGE (node)-[:usedBy { label:"Week 08"}]->(parent);
MERGE (node:`_code`:`_code_week-number` { value:"week-09" });
MATCH (parent:`_code_list`:`_code_list_week-number`),(node:`_code`:`_code_week-number` { value:"week-09" }) MERGE (node)-[:usedBy { label:"Week 09"}]->(parent);
