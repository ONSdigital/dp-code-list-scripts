...
MATCH (parent:`_code_list`:`_code_list_enterprise-regions`),(node:`_code`:`_code_geography` { value:"E37000002" }) MERGE (node)-[:usedBy { label:"Buckinghamshire Thames Valley"}]->(parent);
...
MATCH (parent:`_code_list`:`_code_list_enterprise-regions`),(node:`_code`:`_code_geography` { value:"E37000004" }) MERGE (node)-[:usedBy { label:"Coast to Capital"}]->(parent);
...
MATCH (parent:`_code_list`:`_code_list_enterprise-regions`),(node:`_code`:`_code_geography` { value:"E37000008" }) MERGE (node)-[:usedBy { label:"Derby, Derbyshire, Nottingham and Nottinghamshire"}]->(parent);
...
MATCH (parent:`_code_list`:`_code_list_enterprise-regions`),(node:`_code`:`_code_geography` { value:"E37000010" }) MERGE (node)-[:usedBy { label:"Enterprise M3"}]->(parent);
...
MATCH (parent:`_code_list`:`_code_list_enterprise-regions`),(node:`_code`:`_code_geography` { value:"E37000017" }) MERGE (node)-[:usedBy { label:"Hertfordshire"}]->(parent);
MERGE (node:`_code`:`_code_geography` { value:"E37000018" });
MATCH (parent:`_code_list`:`_code_list_enterprise-regions`),(node:`_code`:`_code_geography` { value:"E37000018" }) MERGE (node)-[:usedBy { label:"Humber"}]->(parent);
...
MATCH (parent:`_code_list`:`_code_list_enterprise-regions`),(node:`_code`:`_code_geography` { value:"E37000020" }) MERGE (node)-[:usedBy { label:"Leeds City Region"}]->(parent);
...
MATCH (parent:`_code_list`:`_code_list_enterprise-regions`),(node:`_code`:`_code_geography` { value:"E37000023" }) MERGE (node)-[:usedBy { label:"London"}]->(parent);
MERGE (node:`_code`:`_code_geography` { value:"E37000024" });
MATCH (parent:`_code_list`:`_code_list_enterprise-regions`),(node:`_code`:`_code_geography` { value:"E37000024" }) MERGE (node)-[:usedBy { label:"New Anglia"}]->(parent);
...
MATCH (parent:`_code_list`:`_code_list_enterprise-regions`),(node:`_code`:`_code_geography` { value:"E37000027" }) MERGE (node)-[:usedBy { label:"Oxfordshire"}]->(parent);
MERGE (node:`_code`:`_code_geography` { value:"E37000029" });
MATCH (parent:`_code_list`:`_code_list_enterprise-regions`),(node:`_code`:`_code_geography` { value:"E37000029" }) MERGE (node)-[:usedBy { label:"Solent"}]->(parent);
MERGE (node:`_code`:`_code_geography` { value:"E37000030" });
MATCH (parent:`_code_list`:`_code_list_enterprise-regions`),(node:`_code`:`_code_geography` { value:"E37000030" }) MERGE (node)-[:usedBy { label:"South East"}]->(parent);
...
MATCH (parent:`_code_list`:`_code_list_enterprise-regions`),(node:`_code`:`_code_geography` { value:"E37000039" }) MERGE (node)-[:usedBy { label:"York, North Yorkshire and East Riding"}]->(parent);
MERGE (node:`_code`:`_code_geography` { value:"E37000040" });
MATCH (parent:`_code_list`:`_code_list_enterprise-regions`),(node:`_code`:`_code_geography` { value:"E37000040" }) MERGE (node)-[:usedBy { label:"Sheffield City Region"}]->(parent);
MERGE (node:`_code`:`_code_geography` { value:"E37000041" });
MATCH (parent:`_code_list`:`_code_list_enterprise-regions`),(node:`_code`:`_code_geography` { value:"E37000041" }) MERGE (node)-[:usedBy { label:"South East Midlands"}]->(parent);
MERGE (node:`_code`:`_code_geography` { value:"E37000042" });
MATCH (parent:`_code_list`:`_code_list_enterprise-regions`),(node:`_code`:`_code_geography` { value:"E37000042" }) MERGE (node)-[:usedBy { label:"Greater Cambridge and Greater Peterborough"}]->(parent);
MERGE (node:`_code`:`_code_geography` { value:"E37000013" });
MATCH (parent:`_code_list`:`_code_list_enterprise-regions`),(node:`_code`:`_code_geography` { value:"E37000013" }) MERGE (node)-[:usedBy { label:"Greater Cambridge and Greater Peterborough"}]->(parent);
MERGE (node:`_code`:`_code_geography` { value:"E37000026" });
MATCH (parent:`_code_list`:`_code_list_enterprise-regions`),(node:`_code`:`_code_geography` { value:"E37000026" }) MERGE (node)-[:usedBy { label:"Northamptonshire"}]->(parent);
MERGE (node:`_code`:`_code_geography` { value:"E37000031" });
MATCH (parent:`_code_list`:`_code_list_enterprise-regions`),(node:`_code`:`_code_geography` { value:"E37000031" }) MERGE (node)-[:usedBy { label:"South East Midlands"}]->(parent);
